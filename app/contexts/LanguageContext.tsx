...
const translations = {
    pt: {
        ...
        'hero.testimonial1.quote': 'O sistema entregue superou o briefing. Performance impecável e suporte direto em cada etapa.',
        'hero.testimonial1.author': 'Marina Costa',
        'hero.testimonial1.role': 'Diretora de Operações',
        'hero.testimonial1.company': 'Nexus Labs',
        'hero.testimonial2.quote': 'Migrar nosso ERP para uma solução sob medida reduziu retrabalho e deu visibilidade real ao time.',
        'hero.testimonial2.author': 'Rafael Mendes',
        'hero.testimonial2.role': 'CEO',
        'hero.testimonial2.company': 'Voltex',
        'hero.testimonial3.quote': 'Design moderno, código limpo e entregas no prazo. Hoje nosso produto digital é referência no setor.',
    ...
    en: {
        ...
        'hero.testimonial1.quote': 'The delivered system exceeded the brief. Flawless performance and direct support at every stage.',
        'hero.testimonial1.author': 'Marina Costa',
        'hero.testimonial1.role': 'Operations Director',
        'hero.testimonial1.company': 'Nexus Labs',
        'hero.testimonial2.quote': 'Migrating our ERP to a custom solution reduced rework and gave the team real visibility.',
        'hero.testimonial2.author': 'Rafael Mendes',
        'hero.testimonial2.role': 'CEO',
        'hero.testimonial2.company': 'Voltex',
        'hero.testimonial3.quote': 'Modern design, clean code, and on-time delivery. Our digital product is now a benchmark in the industry.',
        'hero.testimonial3.author': 'Camila Rocha',
