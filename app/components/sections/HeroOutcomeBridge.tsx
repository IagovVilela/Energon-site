  ...
  return (
    ...
    >
      ...
      <div className="container relative py-10 sm:py-14 md:py-20">
        <div className="grid lg:grid-cols-[1fr_auto] gap-8 lg:gap-16 items-end mb-8 sm:mb-12">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 lg:gap-10 border-t lg:border-t-0 lg:border-l border-border pt-6 sm:pt-8 lg:pt-0 lg:pl-10">
            {stats.map((stat) => (
